...
export default {  
    ...
    computed: {
        ...
        parentTitle(){
            if(this.$route.params.category == 'property'){
                return this.titleCase(this.$route.params.type) + ' properties for ' + this.titleCase(this.$route.params.city.replace('-', ' '))
            } else {
                return this.titleCase(this.$route.params.type) + ' properties for ' + this.$route.params.category +' in '+ this.titleCase(this.$route.params.city.replace('-', ' '))
            }
        },
        pageQuestion(){
            if(this.$route.params.category == 'property'){
                return this.$route.params.type.toLowerCase() + ' property for ' + this.titleCase(this.$route.params.city.replace('-', ' '))
            } else {
                return this.$route.params.type.toLowerCase() + ' property for ' + this.$route.params.category +' in '+ this.titleCase(this.$route.params.city.replace('-', ' '))
            }
        }, 
        pageIntro(){
            if(this.$route.params.category == 'property'){
                return this.$route.params.type.toLowerCase() + ' properties for ' + this.titleCase(this.$route.params.city.replace('-', ' '))
            } else {
                return this.$route.params.type.toLowerCase() + ' properties for ' + this.$route.params.category +' in '+ this.titleCase(this.$route.params.city.replace('-', ' '))
            }
        }, 
        pageTitle(){
            if(this.$route.params.category == 'property'){
